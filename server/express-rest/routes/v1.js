...
router.post(    '/news',             passport.authenticate('jwt', {session:false}), NewsController.create);                  // C
router.get(     '/news',             passport.authenticate('jwt', {session:false}), NewsController.getAll);                  // R

router.get(     '/news/:news_id', passport.authenticate('jwt', {session:false}), custom.news, NewsController.get);     // R
router.put(     '/news/:news_id', passport.authenticate('jwt', {session:false}), custom.news, NewsController.update);  // U
router.delete(  '/news/:news_id', passport.authenticate('jwt', {session:false}), custom.news, NewsController.remove);  // D
